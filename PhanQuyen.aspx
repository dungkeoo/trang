<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PhanQuyen.aspx.cs" Inherits="PhanQuyen" %>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <h2 class="card-title">Danh sách kho được quản lý </h2>
                                                ...
                                                <asp:Repeater runat="server" ID="Repeater_ThuKho_List">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:LinkButton CssClass="col-md-6" ForeColor="DarkBlue" Text='<i class="la la-pencil-square"></i>' CommandName='<%#Eval("ID") %>' runat="server" ID="LinkButton1" OnClick="EditObject_Click" />
                                                                <asp:LinkButton CssClass="col-md-6" ForeColor="Red" Text=' <i class="la la-trash"></i>' CommandName='<%#Eval("ID") %>' runat="server" ID="LinkButton2" OnClick="DeleteObject_Click" />
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
